...
export default function ForeverStartsAlbumPage() {
  ...
  const RELEASE_DATE = new Date("2027-06-04T00:00:00");
  ...
  const tracks = [
    { id: "01", title: "Windows Down Forever", duration: "3:32", badge: "SINGLE" },
    { id: "02", title: "Weekend Starts Now", duration: "3:24", badge: "SINGLE" },
    { id: "03", title: "Small Town Gold", duration: "3:45" },
    { id: "04", title: "Pull Me Closer", duration: "3:18" },
    { id: "05", title: "Kiss Me Like You Mean It", duration: "3:50", badge: "SINGLE" },
    { id: "06", title: "Feels Like Home", duration: "4:05" },
    { id: "07", title: "Good to Be Alive", duration: "3:28" },
    { id: "08", title: "Anywhere With You", duration: "3:40" },
    { id: "09", title: "Right Where We Belong", duration: "3:56" },
    { id: "10", title: "Forever Starts", duration: "4:12", badge: "SINGLE" },
    { id: "11", title: "Always You", duration: "3:38" },
    { id: "12", title: "The Best Is Yet to Come", duration: "4:22" }
  ];
  ...
  const singles = [
    {
      ...
      description: "A sweeping, triumphant country anthem celebrating unconditional devotion and the promise of a lifetime together."
    },
    {
      title: "Windows Down Forever",
      image: "/images/forever-starts-album.jpg",
      tagline: "Summer Lead Single",
      description: "Driving kick drums, acoustic power, and open-road freedom made for summer nights under wide Tennessee skies."
    },
    {
      title: "Weekend Starts Now",
      image: "/images/forever-starts-album.jpg",
      tagline: "Upbeat Radio Single",
      description: "A high-energy, feel-good weekend anthem designed for tailgate celebrations and dance floors across the heartland."
    },
    {
      title: "Kiss Me Like You Mean It",
      image: "/images/forever-starts-album.jpg",
      tagline: "Romantic Single",
      description: "Passionate storytelling and soaring fiddle melodies capturing the spark and depth of true love."
    }
  ];
      ...
      <section style={{ padding: '8rem 8% 4rem', background: 'linear-gradient(to bottom, #0a0a0a, #050505)' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <Image 
              src="/images/forever-starts-album.jpg" 
              alt="Forever Starts Album Cover" 
              fill 
          ...
          <div>
            ...
            <h1 style={{ 
              ...
              FOREVER <span style={{ color: 'var(--accent-gold)' }}>STARTS</span>
            </h1>
            ...
            <div style={{ 
              ...
              <div>RELEASE DATE: <strong style={{ color: 'white' }}>4 JUNE 2027</strong></div>
            ...
            <p style={{ 
              ...
              *Forever Starts* is a landmark modern country album celebrating new horizons, enduring romance, and the joy of stepping into a shared future. Driven by anthemic hooks, warm organic instrumentation, and Ryker Boone&apos;s rich baritone, these 12 tracks weave heartland authenticity with uplifting summer melodies made for open roads and front porches.
            </p>
