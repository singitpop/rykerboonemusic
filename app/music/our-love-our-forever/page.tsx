        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{ display: 'flex', gap: '1.5rem', flexWrap: 'wrap' }}>
              <a 
                href={RYKER_ALBUM_LINKS.ourLoveOurForever.spotify}
                target="_blank"
              ...
              <a 
                href={RYKER_ALBUM_LINKS.ourLoveOurForever.appleMusic}
                target="_blank"
                rel="noopener noreferrer"
                style={{
              ...
              <a 
                href={RYKER_ALBUM_LINKS.ourLoveOurForever.amazonMusic}
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  border: '1px solid rgba(255,255,255,0.2)',
              ...
              <a 
                href={RYKER_ALBUM_LINKS.ourLoveOurForever.youtube}
                target="_blank"
                rel="noopener noreferrer"
                style={{
                  border: '1px solid rgba(255,255,255,0.2)',
